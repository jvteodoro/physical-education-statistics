...
def _(mo):
    ...
    **Objetivo da semana:** Descrever o nível de desenvolvimento motor com médias, desvios-padrão e histogramas.

    **Por que isso importa?** A primeira semana introduz como resumir um conjunto de dados antes de pensar em modelos. O notebook mostra passo a passo como ler a base, escolher variáveis e interpretar média, mediana e dispersão.
...
def _(df, mo, plt, sns, variavel_x):
    ...
    ax.set_title("Histograma de " + variavel_x.value)
...
def _(df, mo, plt, sns, variavel_x):
    ...
    if coluna_grupo in df.columns:
        ...
        ax.set_title("Comparação por sexo para " + variavel_x.value)
        componentes.extend([
